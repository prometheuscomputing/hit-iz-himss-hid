...
angular.module("cf").factory("CFTestPlanExecutioner", [ "$q", "$http", "$rootScope", "CacheFactory", "$localForage", function($q, $http, $rootScope, CacheFactory, $localForage) {
    var manager = {
        getTestPlan: function(id) {
            var delay = $q.defer();
            $http.get("api/cf/testplans/" + id + "/updateDate", {
                timeout: 18e4
            }).then(function(date) {
...
angular.module("cf").factory("CFTestPlanManager", [ "$q", "$http", function($q, $http) {
    var manager = {
        ...
        refreshTestStepGroupTestContextModels: function(format, testStepGroupId) {
            var delay = $q.defer();
            $http.post("api/cf/" + format + "/management/testStepGroups/" + testStepGroupId + "/refreshTestContext").then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
                delay.reject(response.data);
            });
        ...
        refreshTestPlanTestContextModels: function(format, testPlanId) {
            var delay = $q.defer();
            $http.post("api/cf/" + format + "/management/testPlans/" + testPlanId + "/refreshTestContext").then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
                delay.reject(response.data);
            });
        ...
        refreshTestStepTestContextModels: function(format, testStepId) {
            var delay = $q.defer();
            $http.post("api/cf/" + format + "/management/testSteps/" + testStepId + "/refreshTestContext").then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
                delay.reject(response.data);
            });
        ...
        unPublishTestPlan: function(groupId) {
            var delay = $q.defer();
            $http.post("api/cf/management/testPlans/" + groupId + "/unPublish").then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
                delay.reject(response.data);
            });
...
angular.module("cb").factory("CBTestPlanLoader", [ "$q", "$http", "$rootScope", "CacheFactory", "$localForage", function($q, $http, $rootScope, CacheFactory, $localForage) {
    return function(id, domain) {
        var delay = $q.defer();
        $http.get("api/cb/testplans/" + id + "/updateDate", {
            timeout: 18e4
        }).then(function(date) {
...
angular.module("cb").factory("CBTestPlanManager", [ "$q", "$http", function($q, $http) {
    var manager = {
        ...
        updateTestCaseGroupName: function(node) {
            var delay = $q.defer();
            $http.post("api/cb/management/testCaseGroups/" + node.id + "/name", {
                name: node.editName
            }).then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
        ...
        updateTestCaseName: function(node) {
            var delay = $q.defer();
            $http.post("api/cb/management/testCases/" + node.id + "/name", {
                name: node.editName
            }).then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
        ...
        updateTestStepName: function(node) {
            var delay = $q.defer();
            $http.post("api/cb/management/testSteps/" + node.id + "/name", {
                name: node.editName
            }).then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
        ...
        updateTestPlanName: function(node) {
            var delay = $q.defer();
            $http.post("api/cb/management/testPlans/" + node.id + "/name", {
                name: node.editName
            }).then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
        ...
        getTestStepsWithExternalValueSets: function(testPlanId) {
            var delay = $q.defer();
            $http.get("api/cb/management/testPlans/" + testPlanId + "/testStepsWithExternalValueSets", {
                timeout: 18e4
            }).then(function(testSteps) {
        ...
        updateTestContextApiKeys: function(testContextId, apikeys) {
            var delay = $q.defer();
            $http.post("api/hl7v2/testcontext/" + testContextId + "/apikey", apikeys).then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
                delay.reject(response.data);
            });
        ...
        refreshTestPlanTestContextModels: function(testPlan) {
            var delay = $q.defer();
            $http.post("api/cb/management/testPlans/" + testPlan.id + "/refreshTestContext").then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
                delay.reject(response.data);
            });
...
angular.module("account").factory("Account", function($http, $resource, $q) {
    ...
    accountService.disableAccount = function(id) {
        var delay = $q.defer();
        $http.post("api/accounts/" + id + "/disable").then(function(object) {}, function(response) {
            console.log("error");
            delay.reject(response.data);
        });
        return delay.promise;
...
angular.module("account").factory("notificationService", function($http, $q) {
    ...
    notificationService.saveNotification = function(notification) {
        ...
        $http.post("api/notification/add", data).then(function(object) {
    ...
    notificationService.updateNotification = function(notification) {
        var delay = $q.defer();
        var data = angular.fromJson(notification);
        $http.post("api/notification/update", data).then(function(object) {
            var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
            delay.resolve(res);
        }, function(response) {
            console.log("error");
    ...
    notificationService.getAllNotifications = function(notification) {
        var delay = $q.defer();
        $http.get("api/notification/all").then(function(object) {
            var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
            delay.resolve(res);
        }, function(response) {
            delay.reject(response.data);
...
angular.module("account").factory("apikeysService", function($http, $q) {
    ...
    apikeysService.getCBTestStepsWithExternalValueSets = function(scope, domain) {
        var delay = $q.defer();
        $http.get("api/cb/management/testStepsWithExternalValueSetsFromAllTestPlans", {
            timeout: 18e4,
            params: {
                scope: scope,
                domain: domain
    ...
    apikeysService.getCFTestStepsWithExternalValueSets = function(scope, domain) {
        var delay = $q.defer();
        $http.get("api/cf/management/testStepsWithExternalValueSetsFromAllTestPlans", {
            timeout: 18e4,
            params: {
                scope: scope,
                domain: domain
    ...
    apikeysService.getCBTestStepsWithExternalValueSets = function(testPlanId) {
        ...
        var delay = $q.defer();
        $http.get("api/cf/management/testPlans/" + testPlanId + "/testStepsWithExternalValueSets", {
            timeout: 18e4
        }).then(function(testSteps) {
            delay.resolve(angular.fromJson(testSteps.data));
        }, function(response) {
...
angular.module("doc").factory("DocumentationManager", [ "$q", "$http", function($q, $http) {
    var manager = {
        ...
        getDocumentContent: function(id) {
            var delay = $q.defer();
            $http.get("api/documentation/documents/" + id + "/content").then(function(object) {
                delay.resolve(object.data);
            }, function(response) {
                delay.reject(response.data);
            });
...
angular.module("domains").factory("DomainsManager", [ "$q", "$http", function($q, $http) {
    var manager = {
        ...
        getUpdateDate: function(id) {
            var delay = $q.defer();
            $http.get("api/domains/" + id + "/updateDate", {
                timeout: 6e4
            }).then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
...
angular.module("logs").factory("ValidationLogService", [ "$q", "$http", function($q, $http) {
    var service = {
        ...
        getLogsByDateRange: function(domain, startDate, endDate) {
            var delay = $q.defer();
            $http.get("api/logs/validation/" + domain + "/range?startDate=" + startDate + "&endDate=" + endDate, {
                timeout: 18e4
            }).then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
...
angular.module("logs").factory("TransportLogService", [ "$q", "$http", function($q, $http) {
    var service = {
        ...
        getLogsByDateRange: function(domain, startDate, endDate) {
            var delay = $q.defer();
            $http.get("api/logs/transport/" + domain + "/range?startDate=" + startDate + "&endDate=" + endDate, {
                timeout: 18e4
            }).then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
...
angular.module("reports").factory("ReportService", [ "$rootScope", "$http", "$q", "$filter", "Notification", "FileSaver", function($rootScope, $http, $q, $filter, Notification, FileSaver) {
    var service = {
        ...
        createMessageValidationReport: function(testStepId) {
            ...
            $http.post("api/tsReport/create", data).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
            }, function(response) {
                delay.reject(response.data);
        ...
        initTestStepValidationReport: function(testStepId) {
            ...
            $http.post("api/tsReport/init", data, config).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
            }, function(response) {
                delay.reject(response.data);
        ...
        updateTestStepValidationReport: function(testReportId, testStepId, result, comments) {
            ...
            $http.post("api/tsReport/save", data).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
            }, function(response) {
                delay.reject(response.data);
        ...
        saveValidationReport: function(testStepValidationReportId) {
            ...
            $http.post("api/userTSReport/savePersistentUserTestStepReport", data).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
            }, function(response) {
                console.log("error");
        ...
        saveTestCaseValidationReport: function(testCaseId, testStepReportIds, result, comments, testPlanName, testGroupName) {
            ...
            $http.post("api/userTCReport/savePersistentUserTestCaseReport", data).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
            }, function(response) {
                delay.reject(response.data);
        ...
        getAllTSByAccountIdAndDomain: function(domain) {
            var delay = $q.defer();
            $http.get("api/userTSReport/domain/" + domain, {
                timeout: 18e4
            }).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
        ...
        getAllTSByAccountIdAndDomainAndtestStepId: function(domain, testStepId) {
            var delay = $q.defer();
            $http.get("api/userTSReport/domain/" + domain + "/testStep/" + testStepId, {
                timeout: 18e4
            }).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
        ...
        getAllTCByAccountIdAndDomainAndtestCaseId: function(domain, testCaseId) {
            var delay = $q.defer();
            $http.get("api/userTCReport/domain/" + domain + "/testCase/" + testCaseId, {
                timeout: 18e4
            }).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
        ...
        getAllTCByAccountIdAndDomain: function(domain) {
            var delay = $q.defer();
            $http.get("api/userTCReport/domain/" + domain, {
                timeout: 18e4
            }).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
        ...
        getUserTSReportHTML: function(id) {
            var delay = $q.defer();
            $http.get("api/userTSReport/" + id + "/html", {
                timeout: 18e4
            }).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
        ...
        getUserTCReportHTML: function(id) {
            var delay = $q.defer();
            $http.get("api/userTCReport/" + id + "/html", {
                timeout: 18e4
            }).then(function(object) {
                var res = object.data != null && object.data != "" ? angular.fromJson(object.data) : null;
                delay.resolve(res);
        ...
        deleteTSReport: function(reportId) {
            var delay = $q.defer();
            $http.post("api/userTSReport/" + reportId + "/deleteReport").then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
                delay.reject(response.data);
            });
        ...
        deleteTCReport: function(reportId) {
            var delay = $q.defer();
            $http.post("api/userTCReport/" + reportId + "/deleteReport").then(function(object) {
                delay.resolve(angular.fromJson(object.data));
            }, function(response) {
                delay.reject(response.data);
            });
    ...
    var manager = {
        ...
        cacheCFTestPlans: function(scope, domain) {
            CFTestPlanExecutioner.getTestPlans(scope, domain).then(function(testPlans) {
                for (var i = 0; i < testPlans.length; i++) {
                    CFTestPlanExecutioner.getTestPlan(testPlans[i].id, $rootScope.domain).then(function(testPlan) {}, function(error) {});
                }
            }, function(error) {
                $scope.error = "Sorry, Cannot load the test plans. Please try again";
            });
        ...
        $localForage.getItem("hiddenNotifications", true).then(function(hiddenIds) {
            if (hiddenIds !== null) {
                filteredData = filteredData.filter(function(noti) {
                    return noti.dismissable === false || hiddenIds.indexOf(noti.id) === -1;
                });
            }
        }, function(error) {}).finally(function() {
            if (angular.equals(filteredData, $scope.notifications)) {} else {
...
angular.module("cf").controller("CFTestManagementCtrl", [ "$scope", "$http", "$window", "$filter", "$rootScope", "$timeout", "StorageService", "TestCaseService", "TestStepService", "FileUploader", "Notification", "userInfoService", "CFTestPlanManager", "modalService", "$modalStack", "$modal", "$routeParams", "$location", function($scope, $http, $window, $filter, $rootScope, $timeout, StorageService, TestCaseService, TestStepService, FileUploader, Notification, userInfoService, CFTestPlanManager, modalService, $modalStack, $modal, $routeParams, $location) {
    ...
    $scope.editAPIKeys = function(item) {
        ...
        modalInstance.result.then(function(apiKeys) {
...
angular.module("cf").controller("CFManageADDAPIKeysCtrl", function($scope, $http, $window, $modal, $filter, $rootScope, $timeout, StorageService, FileUploader, Notification, $modalInstance, externalVS) {
...
angular.module("cf").controller("CFManageEDITAPIKeysCtrl", function($scope, $http, $window, $modal, $filter, $rootScope, $timeout, StorageService, FileUploader, Notification, $modalInstance, apiKeys) {
    ...
    $scope.validatefiles = function(token) {
        ...
        $http.get("api/cf/hl7v2/management/validate", {
            ...
            if (response.data.success == true) {
                CFTestPlanManager.getTokenProfiles("hl7v2", token).then(function(response) {
                    if (response.success == false) {
                        if (response.debugError === undefined) {
                            Notification.error({
...
angular.module("cb").controller("CBTestManagementCtrl", function($scope, $window, $filter, $rootScope, CB, $timeout, $sce, StorageService, TestCaseService, TestStepService, CBTestPlanManager, User, userInfoService, $modal, Notification, $modalStack, $location, $routeParams) {
    ...
    $scope.editAPIKeys = function(testPlan) {
        ...
        modalInstance.result.then(function(externalVS) {}, function(result) {});
    };
...
angular.module("cb").controller("CBManageAPIKeysCtrl", function($scope, $http, $window, $modal, $filter, $rootScope, $timeout, StorageService, FileUploader, Notification, $modalInstance, CBTestPlanManager, testPlan) {
    ...
    $scope.getTestStepsWithExternalValueSets = function(testPlan) {
        CBTestPlanManager.getTestStepsWithExternalValueSets(testPlan.id).then(function(testSteps) {
            ...
            for (var i = 0; i < testSteps.length; i++) {
                for (var j = 0; j < testSteps[i].testContext.apikeys.length; j++) testSteps[i].testContext.apikeys[j].editBindingKey = false;
            }
...
angular.module("logs").controller("LogCtrl", [ "$scope", "ValidationLogService", "TransportLogService", "$rootScope", "$timeout", function($scope, ValidationLogService, TransportLogService, $rootScope, $timeout) {
    ...
    $scope.logValidationDateQuery = {
        after: firstDay,
        before: lastDay
    };
    $scope.logTransportDateQuery = {
        after: firstDay,
        before: lastDay
    };
...
angular.module("account").controller("APIKeysCtrl", [ "$scope", "$rootScope", "MultiTestersLoader", "MultiSupervisorsLoader", "Account", "$modal", "$resource", "AccountLoader", "userInfoService", "$location", "Notification", "CBTestPlanListLoader", "apikeysService", "$q", "StorageService", function($scope, $rootScope, MultiTestersLoader, MultiSupervisorsLoader, Account, $modal, $resource, AccountLoader, userInfoService, $location, Notification, CBTestPlanListLoader, apikeysService, $q, StorageService) {
    ...
    $scope.saveCB = function() {
        ...
        for (var i = 0; i < $scope.CBtestSteps.length; i++) {
            ...
            if (hasEditedKeys) {
                promises.push(apikeysService.updateTestContextApiKeys($scope.CBtestSteps[i].testContext.id, $scope.CBtestSteps[i].testContext.apikeys).then(function(response) {}, function(error) {
                    $scope.error = "Sorry, Cannot load the test steps. Please try again";
                }));
            }
        }
    ...
    $scope.saveCF = function() {
        ...
        for (var i = 0; i < $scope.CFtestSteps.length; i++) {
            ...
            if (hasEditedKeys) {
                promises.push(apikeysService.updateTestContextApiKeys($scope.CFtestSteps[i].testContext.id, $scope.CFtestSteps[i].testContext.apikeys).then(function(response) {}, function(error) {
                    $scope.error = "Sorry, Cannot load the test steps. Please try again";
                }));
            }
        }
...
angular.module("doc").controller("ReleaseNotesCtrl", function($scope, $rootScope, $http, $filter, $cookies, $sce, $timeout, DocumentationManager, StorageService, $modal, Notification, modalService, $modalStack) {
    $scope.docs = [];
    $scope.loading = false;
    $scope.error = null;
    $scope.scrollbarWidth = $rootScope.getScrollbarWidth();
...
angular.module("doc").controller("ToolDownloadListCtrl", function($scope, $rootScope, $http, $filter, $cookies, $sce, $timeout, DocumentationManager, StorageService, $modal, Notification, modalService, $modalStack) {
    $scope.loading = false;
    $scope.error = null;
    $scope.scrollbarWidth = $rootScope.getScrollbarWidth();
    $scope.loading = true;
...
angular.module("domains").controller("DomainsCtrl", function($scope, $rootScope, $http, $filter, $cookies, $sce, $timeout, userInfoService, StorageService, DomainsManager, $modal, $location, $window) {
    ...
    $scope.viewDomain = function(domain, waitingTime) {
        waitingTime = waitingTime == undefined ? 1e3 : waitingTime;
