...
RESOURCE_BUNDLE_VERSION="$(grep '^app.resourceBundleVersion=' "$APP_CONFIG" | cut -d= -f2)"
NO_CACHE="${NO_CACHE:-0}"

echo "Building ${IMAGE} (SKIP_FRONTEND=${SKIP_FRONTEND}, platform=${PLATFORM}, resourceBundle=${RESOURCE_BUNDLE_VERSION})"
